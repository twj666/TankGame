...
*/
public class TankExplode extends Explode {

    public TankExplode(int x, int y, GameModel gm) {
        super(x, y, gm);
        this.explode_x = ResourceMgr.explode_1;
        this.width = explode_x[1].getWidth();
        this.height = explode_x[1].getHeight();
        this.step = 1;
